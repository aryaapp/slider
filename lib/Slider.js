...
var Slider = (function (_React$Component) {
  ...
  _createClass(Slider, [{
    ...
    value: function render() {
      ...
      var upper = _react2['default'].createElement(_Handle2['default'], { className: handleClassName, additionalHandleStyles: additionalHandleStyles,
        noTip: isNoTip, tipTransitionName: tipTransitionName, tipFormatter: tipFormatter,
        offset: upperOffset, value: upperBound, dragging: handle === 'upperBound' });

      var lower = null;
      if (range) {
        lower = _react2['default'].createElement(_Handle2['default'], { className: handleClassName, additionalHandleStyles: additionalHandleStyles,
          noTip: isNoTip, tipTransitionName: tipTransitionName, tipFormatter: tipFormatter,
      ...
      return _react2['default'].createElement(
        ...
        upper,
        lower,
        _react2['default'].createElement(_Track2['default'], { className: prefixCls + '-track', additionalTrackStyles: additionalTrackStyles, included: isIncluded,
